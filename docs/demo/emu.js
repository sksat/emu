...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'emu.data';
    var REMOTE_PACKAGE_BASE = 'emu.data';
...
Module['FS_createPath']('/', 'sample', true, true);
Module['FS_createPath']('/', 'font', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_emu.data');

    };
    Module['addRunDependency']('datafile_emu.data');
 ...
 loadPackage({"files": [{"filename": "/sample/haribote.img", "start": 0, "end": 1474560, "audio": 0}, {"filename": "/font/hankaku.bin", "start": 1474560, "end": 1478661, "audio": 0}], "remote_package_size": 1478661, "package_uuid": "2f586c45-0048-4509-8f82-7f18f63e590c"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5274928,
    DYNAMIC_BASE = 5274928,
    DYNAMICTOP_PTR = 32016;
...
var ASM_CONSTS = [function() { var c = document.createElement("canvas"); c.setAttribute("id", "vram"); },
 function($0, $1, $2, $3, $4) { function rgb2hex(rgb){ return "#" + rgb.map( function(value){ return ( "0" + value.toString(16)).slice(-2); }).join(""); } var canvas = document.getElementById("canvas"); var c = canvas.getContext("2d"); const col = rgb2hex([$2, $3, $4]); c.fillStyle = col; c.fillRect($0, $1, 2, 2); console.log($0, $1, $2, $3, $4, c.fillStyle); },
 function() { var canvas = document.getElementById("canvas"); var c = canvas.getContext("2d"); c.fillStyle = 'rgb(255, 0, 0)'; }];
